...
| Jobs | External HTTP cron hits `/api/automations/cron` (also drains AI follow-ups), `/api/flows/cron`, `/api/whatsapp/broadcast/cron`, `/api/shopify/notifications/cron`, `/api/voice/cron` |

...
export interface Profile {
  ...
  user_id: string;
  /**
   * Sequential public ID (1001+), assigned by
   * `109_profile_number_id.sql`. Shown in Settings instead of the
   * auth UUID. Internal FKs stay on `user_id`.
   */
  number_id?: number;
  full_name: string;
  email: string;
...
export interface Contact {
  ...
  account_id: string;
  phone: string | null;
  /** whatsapp | messenger | instagram. Migration 107. */
  channel?: ChannelType;
...
export interface Conversation {
  ...
  account_id: string;
  contact_id: string;
  /** Denormalized from the contact. Migration 107. */
  channel?: ChannelType;
...
export type MetaChannelStatus = "connected" | "disconnected";
...
export interface MetaPageConnection {
  ...
  messenger_status: MetaChannelStatus;
  instagram_status: MetaChannelStatus;
  subscribed_apps_at?: string | null;
  connected_at?: string | null;
  onboarding_source: "facebook_login" | "manual";
